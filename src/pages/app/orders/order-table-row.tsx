...
export function OrderTableRow({ order }: OrderTableRowProps) {
  ...
  function updateOrdersStatusOnCache(orderId: string, status: OrderStatus) {
    updateOrderDetailOnCache(orderId, status)
  ...
  function updateOrderDetailOnCache(orderId: string, status: OrderStatus) {
    const ordersDetailsCache =
      queryClient.getQueryData<GetOrderDetailsResponse>(['order', orderId])

    if (ordersDetailsCache)
